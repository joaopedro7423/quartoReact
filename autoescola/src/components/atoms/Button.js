...
const ButtonsOutlined = styled(Button)`
...
const ButtonWrapper = (props) => {
  switch (props.variant) {
    case ButtonsVariant.outlined:
      return <ButtonsOutlined {...props} />;
    case ButtonsVariant.link:
...
ButtonWrapper.propTypes = {
  ...
  variant: PropTypes.oneOf(Object.values(ButtonsVariant)),
};
